...
u1 = User.create!(username: 'Hudhayfa', email: 'hudhayfa@hudhayfa.com', password:'password', password_confirmation: 'password', first_name: 'Hudhayfa', last_name: 'Jamalkan', profile_img: 'https://fillmurray.com/200/200')
